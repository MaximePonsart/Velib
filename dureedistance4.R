...
###setwd("F:/R/scientist/scientist/Projet_velib/")
...
#########  Tracage parcours velo sur carte
...
df <- google_directions(origin = c(depart$lat,depart$lon),
                        destination = c(arrivee$lat,arrivee$lon),
                        key = "AIzaSyA6A8jEGpG3__YDEIZngB5x_t8K12g_v7s",
                        mode = "bicycling",
                        simplify = TRUE)

s1<-df$routes$overview_polyline$points
polyline <-s1
