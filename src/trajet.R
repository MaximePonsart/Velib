...
# df : data frame calcul� par l'API Google Direction
...
goCalcTrajet <- function() {
  ...
  #r�sultat final : le trajet de parcours dont la durée est la plus faible
